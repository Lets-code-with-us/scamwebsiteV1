...
const features = [
  {
    ...
    description:
      'The WhatsApp lottery scam is a type of fraudulent scheme where scammers impersonate WhatsApp.',
  },
  {
    id: 2,
    ...
    description:
      'A debit card scam refers to fraudulent activities where scammers use various tactics to obtain sensitive information related to debit cards. ',
  },
  {
    id: 3,
    title: 'Phishing',
    ...
    description:
      'A phishing scam is a type of cyber attack where scammers use deceptive tactics to trick individuals.',
  },
  {
    id: 4,
    ...
    description:
      'Customer care number fraud is a type of scam where fraudsters impersonate customer. ',
  },
  {
    id: 5,
    ...
    description:
      'A ransomware attack is a type of cyberattack where malicious software (ransomware) is used to encrypt files or systems.',
  },
  {
    id: 6,
    ...
    description:
      'A catfishing attack is a type of deceptive online activity where someone creates a fake identity.',
  },
  {
    id: 7,
    title: 'Social Media',
    ...
    description:
      'A social media scam refers to fraudulent activities conducted on social networking platforms with the aim of deceiving users. ',
  },
  {
    id: 8,
    ...
    description:
      'Work-from-home scams are fraudulent schemes that promise individuals the opportunity to earn money from the comfort of their own homes.',
  },

  {
    ...
    description:
      " A digital footprint scam generally refers to fraudulent activities or schemes that exploit an individual's online presence.",
  },
  {
    id: 10,
    title: 'Malware',
    ...
    description:
      'A  malware scam typically involves deceptive tactics used by cybercriminals to trick users.',
  },
  {
    id: 11,
    ...
    description:
      'Social engineering scams involve manipulating people into performing certain actions or revealing sensitive information. ',
  },
  {
    id: 12,
  ...
  },
  {
    ...
    description:
      'A fake website scam involves creating fraudulent websites that mimic legitimate ones to deceive visitors and steal their personal information. ',
  },
  {
    id: 14,
    ...
    description:
      'Gather all relevant information, including chat messages, emails, profiles, and any financial transactions related to the scam.',
  },
  {
    id: 15,
    ...
    description:
      'A fake email scam, also known as phishing, involves sending fraudulent emails to trick individuals.',
  },
  {
    id: 16,
    ...
    <div className="mx-auto max-w-7xl px-2 lg:px-8 pt-24 pb-24">
      <div className="grid grid-cols-1 gap-y-8 text-center sm:grid-cols-2 sm:gap-12 lg:grid-cols-4">
        {features.slice(0, showAll ? features.length : 8).map((feature) => (
          <div key={feature.id}>
            <div
              className={`mx-auto flex h-20 w-20 items-center justify-center rounded-full bg-orange-500`}
            >
              {feature.icon}
            </div>
